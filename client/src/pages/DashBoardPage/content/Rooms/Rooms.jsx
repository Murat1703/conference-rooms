...
import { getHalls, addHall, deleteHall, getHall, updateHall } from '../../../../api/halls.api';
import { addGallery, getHalsGallery } from '../../../../api/halls.gallery.api';
import {  } from 'react';
    ...
    return(
                            ...
                            <div className={cls.hallItem} key={index}>
                                ...
                                <div className={cls.hallItemMore}>
                                    <div className={cls.hallItemButtons}>
                                        ...
                                        <button onClick={()=>handleDeleteItem(hall.id)}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        {showModal && 
            <RoomModal            
                ...
                onAdd={()=>createHall(hallData)}
                onEdit={()=>{updateHallItem(activeID, hallData);}}
